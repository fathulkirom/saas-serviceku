    ...
    <GuestLayout>
        ...
        <form @submit.prevent="resend" class="space-y-4">
            <KButton  type="submit"
                ...
                class="w-full flex items-center justify-center gap-2 px-6 py-3 rounded-xl sk-bg-inverse text-white text-sm font-bold shadow-md hover:sk-bg-inverse focus:ring-2 focus:ring-offset-2 focus:ring-zinc-900 transition-all disabled:opacity-70">
