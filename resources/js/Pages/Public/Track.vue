                    ...
                    <div class="relative">
                        ...
                        <div class="space-y-6 relative">
                            ...
                            <div v-if="service.status !== 'menunggu_alokasi' && service.status !== 'cancel'" class="flex items-start gap-4 relative">
                                <div class="flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center relative z-10 ring-4 ring-white" :class="progressLevel >= 2 ? 'bg-blue-100 text-blue-600' : 'bg-gray-100 text-gray-400'">
