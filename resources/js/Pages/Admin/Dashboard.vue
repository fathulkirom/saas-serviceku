<template>
    <AdminLayout>
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6 animate-fade-in">
            <div class="relative rounded-2xl p-5 border transition-all duration-300 hover:-translate-y-0.5" style="background: var(--bg-card); border-color: var(--border-color);">
        ...
        <!-- ===== GLOBAL STATS ===== -->
        <div v-if="totalStats" class="rounded-2xl p-6 mb-6 border animate-slide-up" style="background: var(--bg-card); border-color: var(--border-color);">
            <h3 class="text-base font-bold text-slate-100 mb-5">Statistik Global Platform</h3>
            <div class="grid grid-cols-3 md:grid-cols-6 gap-6">
                <div class="text-center">
                    <p class="text-2xl font-bold" style="color: var(--accent-primary)">{{ totalStats.total_users }}</p>
                    <p class="text-xs text-slate-400 mt-1">Total User</p>
                </div>
                <div class="text-center">
                    <p class="text-2xl font-bold" style="color: var(--accent-primary)">{{ totalStats.total_services }}</p>
                    <p class="text-xs text-slate-400 mt-1">Total Servis</p>
                </div>
                <div class="text-center">
                    <p class="text-2xl font-bold" style="color: var(--accent-primary)">{{ totalStats.total_sales }}</p>
                ...
                <div class="text-center">
                    <p class="text-2xl font-bold" style="color: var(--accent-primary)">{{ totalStats.total_products }}</p>
                    <p class="text-xs text-slate-400 mt-1">Total Produk</p>
                </div>
                <div class="text-center">
                    <p class="text-2xl font-bold" style="color: var(--accent-primary)">{{ totalStats.total_storage }} MB</p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6 animate-slide-up">
            ...
            <div class="lg:col-span-2 rounded-2xl p-6 border" style="background: var(--bg-card); border-color: var(--border-color);">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <Link :href="route('admin.logs')" class="text-xs font-medium hover:underline" :style="{ color: 'var(--accent-primary)' }">Lihat Semua →</Link>
                </div>
                <div class="space-y-2 max-h-64 overflow-y-auto">
                    <div v-for="log in recentLogs" :key="log.id" class="flex items-center gap-3 py-2.5 px-3 rounded-xl transition-colors" :style="{ borderBottom: '1px solid ' + 'var(--border-light)' }">
        ...
        <!-- ===== QUICK ACTIONS ===== -->
        <div class="rounded-2xl p-6 border animate-slide-up" style="background: var(--bg-card); border-color: var(--border-color);">
            <h3 class="text-base font-bold text-slate-100 mb-4">Aksi Cepat</h3>
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
                <Link :href="route('admin.tenant.create')" class="flex flex-col items-center gap-2 px-4 py-4 rounded-xl transition-all duration-200 hover:-translate-y-0.5 group" style="background: var(--bg-hover); border: 1px solid var(--border-light);">
                ...
                <Link :href="route('admin.plans')" class="flex flex-col items-center gap-2 px-4 py-4 rounded-xl transition-all duration-200 hover:-translate-y-0.5 group" style="background: var(--bg-hover); border: 1px solid var(--border-light);">
                ...
                <Link :href="route('admin.vouchers.create')" class="flex flex-col items-center gap-2 px-4 py-4 rounded-xl transition-all duration-200 hover:-translate-y-0.5 group" style="background: var(--bg-hover); border: 1px solid var(--border-light);">
                ...
                <Link :href="route('admin.backup')" class="flex flex-col items-center gap-2 px-4 py-4 rounded-xl transition-all duration-200 hover:-translate-y-0.5 group" style="background: var(--bg-hover); border: 1px solid var(--border-light);">
                ...
                <Link :href="route('admin.monitoring')" class="flex flex-col items-center gap-2 px-4 py-4 rounded-xl transition-all duration-200 hover:-translate-y-0.5 group" style="background: var(--bg-hover); border: 1px solid var(--border-light);">
                ...
                <Link :href="route('admin.settings')" class="flex flex-col items-center gap-2 px-4 py-4 rounded-xl transition-all duration-200 hover:-translate-y-0.5 group" style="background: var(--bg-hover); border: 1px solid var(--border-light);">
