                ...
                <form @submit.prevent="submit">
                    ...
                    <div class="flex justify-end gap-3 mt-8 pt-6 border-t border-slate-700/50">
                        <KButton  type="submit" :disabled="form.processing"
                            class="px-6 py-2.5 rounded-xl text-sm font-bold text-white transition-all shadow-sm hover:shadow-md hover:-translate-y-0.5 sk-bg-primary hover:sk-bg-primary disabled:opacity-50 disabled:hover:translate-y-0 flex items-center gap-2">
                ...
                <div class="rounded-2xl p-6 border bg-slate-800/50 border-slate-700/50 backdrop-blur-xl shadow-sm">
                    ...
                    <form @submit.prevent="changePlan">
                        ...
                        <KButton  type="submit" :disabled="planForm.processing"
                            class="w-full px-4 py-2.5 sk-bg-primary text-white font-bold rounded-xl hover:sk-bg-primary transition-all shadow-sm hover:shadow-md hover:-translate-y-0.5 disabled:opacity-50 text-sm flex items-center justify-center gap-2">
