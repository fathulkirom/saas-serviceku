            ...
            <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" v-model="form.name" class="w-full rounded-xl border border-zinc-300 px-4 py-2.5 text-sm text-zinc-900 focus:ring-2 focus:ring-indigo-100 focus:border-indigo-500 transition-all" required placeholder="Contoh: Budi Santoso" />
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" v-model="form.phone" class="w-full pl-9 rounded-xl border border-zinc-300 px-4 py-2.5 text-sm text-zinc-900 focus:ring-2 focus:ring-indigo-100 focus:border-indigo-500 transition-all" placeholder="081234567890" />
                                </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="email" v-model="form.email" class="w-full pl-9 rounded-xl border border-zinc-300 px-4 py-2.5 text-sm text-zinc-900 focus:ring-2 focus:ring-indigo-100 focus:border-indigo-500 transition-all" placeholder="budi@example.com" />
                                </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select v-model="form.is_member" class="w-full appearance-none rounded-xl border border-zinc-300 px-4 py-2.5 text-sm text-zinc-900 focus:ring-2 focus:ring-indigo-100 focus:border-indigo-500 transition-all">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea v-model="form.address" rows="3" class="w-full rounded-xl border border-zinc-300 px-4 py-2.5 text-sm text-zinc-900 focus:ring-2 focus:ring-indigo-100 focus:border-indigo-500 transition-all resize-none" placeholder="Masukkan alamat lengkap rumah/kantor pelanggan..."></textarea>
                ...
                <div class="sticky bottom-6 z-10 bg-white rounded-2xl border border-zinc-200 shadow-lg p-4 flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-3 w-full sm:w-auto">
                        ...
                        <button type="submit" :disabled="form.processing" class="flex-1 sm:flex-none px-8 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-bold rounded-xl shadow-sm hover:shadow-md transition-all disabled:opacity-50 flex items-center justify-center gap-2">
