    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex flex-wrap items-center justify-between gap-3">
                <div>
                    <h2 class="text-xl font-bold" style="color: var(--text-primary);">Edit Servis #{{ service.id }}</h2>
                    <p class="text-xs mt-0.5" style="color: var(--text-muted);">Ubah data servis pelanggan</p>
                </div>
        ...
        <form @submit.prevent="submit" class="max-w-3xl mx-auto space-y-5">
            ...
            <div class="rounded-xl border p-5" style="border-color: var(--border-color); background: var(--bg-secondary);">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label class="block text-xs font-semibold mb-1.5 uppercase tracking-wider" style="color: var(--text-muted);">Pelanggan</label>
                    ...
                    <div>
                        <label class="block text-xs font-semibold mb-1.5 uppercase tracking-wider" style="color: var(--text-muted);">Status Servis</label>
                        <select v-model="form.status" class="w-full rounded-xl border px-3 py-2.5 text-sm" :style="{ background: 'var(--bg-input)', color: 'var(--text-primary)', borderColor: 'var(--border-color)' }">
                            <option value="menunggu_alokasi">Menunggu Alokasi</option>
                            <option value="diterima">Diterima</option>
                            <option value="diagnosa">Diagnosa</option>
                            <option value="dikerjakan">Dikerjakan</option>
                            <option value="menunggu_konfirmasi_pelanggan">Konfirmasi Pelanggan</option>
                            <option value="menunggu_konfirmasi_internal">Konfirmasi Internal</option>
                            <option value="siap_diambil">Siap Diambil</option>
                            <option value="indent">Indent</option>
                            <option value="onpartner">Partner</option>
            ...
            <div class="rounded-xl border p-5" style="border-color: var(--border-color); background: var(--bg-secondary);">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label class="block text-xs font-semibold mb-1.5 uppercase tracking-wider" style="color: var(--text-muted);">Jalur Kedatangan</label>
                    ...
                    <div>
                        <label class="block text-xs font-semibold mb-1.5 uppercase tracking-wider" style="color: var(--text-muted);">Kategori Perangkat</label>
                    ...
                    <div>
                        <label class="block text-xs font-semibold mb-1.5 uppercase tracking-wider" style="color: var(--text-muted);">Merek</label>
                    ...
                    <div>
                        <label class="block text-xs font-semibold mb-1.5 uppercase tracking-wider" style="color: var(--text-muted);">Tipe / Model</label>
                    ...
                    <div>
                        <label class="block text-xs font-semibold mb-1.5 uppercase tracking-wider" style="color: var(--text-muted);">IMEI / Serial Number</label>
                    ...
                    <div>
                        <label class="block text-xs font-semibold mb-1.5 uppercase tracking-wider" style="color: var(--text-muted);">Sandi / Pola / PIN</label>
                ...
                <div class="mt-4">
                    <label class="block text-xs font-semibold mb-2 uppercase tracking-wider" style="color: var(--text-muted);">Kelengkapan Bawaan</label>
                    <div class="flex flex-wrap gap-3">
                        <label v-for="eq in equipment" :key="eq.id" class="flex items-center gap-2 text-sm cursor-pointer" style="color: var(--text-secondary);">
            ...
            <div class="rounded-xl border p-5" style="border-color: var(--border-color); background: var(--bg-secondary);">
                ...
                <div class="mb-4">
                    <label class="block text-xs font-semibold mb-1.5 uppercase tracking-wider" style="color: var(--text-muted);">Template Ceklis</label>
                ...
                <div v-if="selectedTemplate" class="space-y-2">
                    <label v-for="item in selectedTemplate.items" :key="item.id" class="flex items-center gap-2 text-sm cursor-pointer" style="color: var(--text-secondary);">
            ...
            <div class="rounded-xl border p-5" style="border-color: var(--border-color); background: var(--bg-secondary);">
                ...
                <div class="mb-4">
                    <label class="block text-xs font-semibold mb-1.5 uppercase tracking-wider" style="color: var(--text-muted);">Deskripsi Masalah / Keluhan</label>
                ...
                <div class="mb-4">
                    <label class="block text-xs font-semibold mb-1.5 uppercase tracking-wider" style="color: var(--text-muted);">Catatan Kondisi Fisik</label>
                ...
                <div class="mb-4">
                    <label class="block text-xs font-semibold mb-1.5 uppercase tracking-wider" style="color: var(--text-muted);">Biaya Jasa</label>
            ...
            <div class="flex justify-end gap-3 pt-2">
                ...
                <button type="submit" :disabled="form.processing" class="px-5 py-2.5 rounded-xl text-sm font-bold text-white transition-all hover:shadow-md disabled:opacity-50" style="background: var(--accent-primary);">
...
const form = useForm({
    ...
    status: props.service.status || 'menunggu_alokasi',
});
